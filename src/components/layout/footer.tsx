...
export default function footer() {
  return (
    <div className='md:px-12 px-4 md:pt-24 pt-16 bg-[#FFD600]'>
      <div className='grid md:grid-cols-[2fr_1fr_1fr_2fr] grid-cols-1 md:gap-20 gap-10'>
        <div className='flex flex-col gap-6'>
          <h4 className='text-xl font-bold text-[#FF66C4]'>Vibrant Minds</h4>
        ...
        <div className='flex flex-col gap-6'>
          <h4 className='text-xl font-bold text-[#FF66C4]'>Our Services</h4>
        ...
        <div className='flex flex-col gap-6'>
          <h4 className='text-xl font-bold text-[#FF66C4]'>Useful links</h4>
          <ul className='text-sm list-none text-[#737373] flex flex-col gap-2'>
            <li>About us</li>
            <li>Our team</li>
        ...
        <div className='flex flex-col gap-6'>
          <h4 className='text-xl font-bold text-[#FF66C4]'>Newsletter</h4>
      ...
      <div className='text-center p-6 mt-6 border-t border-[#737373]'>
