      ...
      <div className='max-w-7xl mx-auto md:px-12 px-4 md:py-28 py-28'>
        <div className='grid md:grid-cols-2 grid-cols-1 gap-10 justify-center items-center'>
          <div className='text-white text-center md:text-start'>
            <p className='text-xl font-semibold pb-4'>subscriptions</p>
            <h2 className='text-4xl pb-4'>Subscribe for a box</h2>
        ...
        <div className='md:px-12 px-4 pt-24 pb-12 mx-auto md:w-3/4 w-full grid md:grid-cols-4 grid-cols-2 gap-10'>
          <div className='text-white text-center flex flex-col items-center justify-center gap-4 text-xl'>
            <h4>44</h4>
