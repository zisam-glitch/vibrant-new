  ...
  return (
    <section className='md:px-12 px-4 max-w-7xl mx-auto '>
      <div className='md:py-16 py-12 grid md:grid-cols-2 grid-cols-1 gap-10 justify-center items-center'>
        <div>
          <h4 className='text-4xl text-[#FF66C4] '>Why Circle Time Matters</h4>
      ...
      <div className='md:py-16 py-12 grid md:grid-cols-2 grid-cols-1 gap-10 justify-center items-center'>
        ...
        <div className='flex flex-col items-end text-right'>
          <h4 className='text-4xl text-[#FF66C4]  '>The Power of Repetition</h4>
          <div className='w-70 my-4 h-[4px] bg-[#FFD600]'></div>
      ...
      <div className='md:py-16 py-12 grid md:grid-cols-2 grid-cols-1 gap-10 justify-center items-center'>
        <div>
          <h4 className='text-4xl text-[#FF66C4] '>Introduction Is Key</h4>
          <div className='w-70 my-4 h-[4px] bg-[#FFD600]'></div>
