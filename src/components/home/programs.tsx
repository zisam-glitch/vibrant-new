...
export default function Classes() {
  return (
    <section className='relative md:px-12 px-4 md:py-24 py-12 bg-[linear-gradient(180deg,rgba(255,255,255,1)_0%,rgba(0,0,0,0.1)_100%)]'>
      <div className='text-center md:w-[40%] w-full mx-auto md:mb-16 mb-8'>
        <h4 className='md:text-xl text-lg font-bold pb-4 text-[#FF66C4]'>Educational Programs</h4>
        <h2 className='md:text-4xl text-2xl font-bold'>Step By Step Systematic Education</h2>
      </div>
          ...
          <div key={classItem.id} className='md:p-10 p-4 grid grid-cols-[1fr_2fr] justify-center items-center md:gap-8 gap-4 md:rounded-[40px] rounded-[20px] bg-[#fff]'>
            ...
            <div>
              <div className='flex flex-col gap-2 md:gap-4 md:py-3 py-0'>
                <h3 className='text-[#710A85] md:text-xl text-lg font-bold'>{classItem.title}</h3>
